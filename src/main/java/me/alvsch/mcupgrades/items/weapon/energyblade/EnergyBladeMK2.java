...
public class EnergyBladeMK2 extends EnergyBlade {

    public EnergyBladeMK2() {
        super(Items.ENERGY_BLADE_MK2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{
                null, SlimefunItems.SYNTHETIC_DIAMOND, null,
                null, Items.ENERGY_BLADE_MK1, null,
